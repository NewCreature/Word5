...
void lingo_title_initialize(void * data)
{
	...
	lingo_menu_add_item(&instance->menu[LINGO_MENU_GAMEPLAY_DUMMY], instance->font[LINGO_FONT_SPRINT_20], "Use Hint", lingo_menu_proc_dummy, 150, 170 + 118 + 24 + 12, LINGO_MENU_ITEM_FLAG_CENTER | LINGO_MENU_ITEM_FLAG_SILENT);
